...
public PaypalResponse(boolean status, String errorMessage, Exception exception) {
 super();
 this.status = status;
...
public PaypalResponse(Object scalarResult, int statusCode) {
 super();
...
public PaypalResponse(boolean status, Object scalarResult, int statusCode) {
 super();
 this.status = status;
 this.scalarResult = scalarResult;
 this.statusCode = statusCode;
...
public PaypalResponse(boolean status, int statusCode, String jsonResponse) {
 super();
 this.status = status;
 this.statusCode = statusCode;
...
public PaypalResponse(int statusCode, String jsonResponse) {
 super();
 this.statusCode = statusCode;
 this.jsonResponse = jsonResponse;
}
